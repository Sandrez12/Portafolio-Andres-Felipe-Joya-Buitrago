    ...
    <div class="container" data-aos="fade-up">
        <div class="project-card rounded p-4 shadow text-center mx-auto" style="max-width: 700px;">
            ...
            <div class="mt-4 d-flex justify-content-center gap-3">
                <a href="https://www.linkedin.com/in/andres-joya-69a552357/" target="_blank" class="btn btn-outline-light rounded-circle"><i class="fab fa-linkedin-in"></i></a>
                <a href="https://github.com/Sandrez12" target="_blank" class="btn btn-outline-light rounded-circle"><i class="fab fa-github"></i></a>
                <a href="https://twitter.com/" target="_blank" class="btn btn-outline-light rounded-circle"><i class="fab fa-twitter"></i></a>
            </div>
        </div>
    </div>
</section>
